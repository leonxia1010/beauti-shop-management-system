      ...
      <nav className="flex space-x-8" aria-label="Tabs">
        {tabs.map((tab) => (
          <Button
            ...
            className={cn(
              'group relative min-w-0 flex-1 overflow-hidden py-4 px-6 text-center text-sm font-medium hover:bg-gray-50 focus:z-10 focus:outline-none transition-all duration-200 rounded-none',
              {
